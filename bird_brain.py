...
class Brain:
    def __init__(self,input_nodes,hidden_nodes,output_nodes):
        ...
        self.wh=np.random.normal(size=(self.input_nodes,self.hidden_nodes))
        self.bh=np.random.normal(size=(1,self.hidden_nodes))
        self.wout=np.random.normal(size=(self.hidden_nodes,self.output_nodes))
        self.bout=np.random.normal(size=(1,self.output_nodes))
